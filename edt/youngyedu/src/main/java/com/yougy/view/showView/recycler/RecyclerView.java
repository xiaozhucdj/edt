package com.yougy.view.showView.recycler;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    private final ViewInfoStore.ProcessCallback mViewInfoProcessCallback =
            new ViewInfoStore.ProcessCallback() {
                ...
                public void processAppeared(ViewHolder viewHolder,
                                            ItemAnimator.ItemHolderInfo preInfo, RecyclerView.ItemAnimator.ItemHolderInfo info) {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        mFlingMaxX = dm.widthPixels;
        mFlingMaxY = dm.heightPixels;
    }
    ...
    public void smoothScrollToPosition(int position) {
        LogUtils.e(TAG, "layoutfrozen is : " + mLayoutFrozen);
        if (mLayoutFrozen) {
            return;
        }
        if (mLayout == null) {
    ...
    boolean scrollByInternal(int x, int y, MotionEvent ev) {
        LogUtils.e(TAG, "scrollByInternal.................");
    ...
    private boolean dispatchOnItemTouch(MotionEvent e) {
        ...
        LogUtils.e(TAG, "dispatchOnItemTouch...................JiangLiang");
        return false;
    }
    ...
    public boolean onGenericMotionEvent(MotionEvent event) {
        LogUtils.e(TAG, "onGenericMotionEvent.................");
        if (mLayout == null) {
            return false;
        }
        if (mLayoutFrozen) {
     ...
     * {@link ItemAnimator#animatePersistence(ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)}
     * DISAPPEARING views are animated via
     * {@link ItemAnimator#animateDisappearance(ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)}
     * APPEARING views are animated via
     * {@link ItemAnimator#animateAppearance(ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)}
     * and changed views are animated via
     * {@link ItemAnimator#animateChange(ViewHolder, ViewHolder, RecyclerView.ItemAnimator.ItemHolderInfo, RecyclerView.ItemAnimator.ItemHolderInfo)}.
     */
    void dispatchLayout() {
        if (mAdapter == null) {
    ...
    private void handleMissingPreInfoForChangeError(long key,
        ...
        LogUtils.e(TAG, "Problem while matching changed view holders with the new"
    ...
    private void recordAnimationInfoIfBouncedHiddenView(ViewHolder viewHolder,
                                                        RecyclerView.ItemAnimator.ItemHolderInfo animationInfo) {
    ...
    public void onScrollStateChanged(int state) {
        int currentPage;
        int shortestDistance = getWidth() / 4;
        // Do nothing
        switch (state) {
            case 2:
                scrollState = 2;
            ...
            case 0:
                ...
                LogUtils.e(TAG, "onScrollStateChanged  scrollX is : " + scrollX);
                scrollState = 0;
                ...
                if (null != mCurrentPositionChangeListener) {
                    mCurrentPositionChangeListener.onCurrentPositionChange(currentPage - 1);
                }
                LogUtils.e("PageRecyclerView", "currentPage is : " + currentPage);
                // 执行自动滚动
    ...
    public void updateScrollX(int disPage) {
        LogUtils.e(TAG, "updateScrollX is : " + disPage);
        LogUtils.e(TAG, "scrollX was : " + scrollX);
//        this.scrollX += disPage * getWidth();
        LogUtils.e(TAG, "scrollX is : " + scrollX);
    }

    private OnCurrentPositionChangeListener mCurrentPositionChangeListener;

    public void addOnCurrentPositionChangeListener(OnCurrentPositionChangeListener onCurrentPositionChangeListener) {
        this.mCurrentPositionChangeListener = onCurrentPositionChangeListener;
    }

    public interface OnCurrentPositionChangeListener {
        void onCurrentPositionChange(int currentPosition);
    }
    ...
    public final class Recycler {
        ...
        View getViewForPosition(int position, boolean dryRun) {
            LogUtils.e(TAG, "getViewForPosition..................");
            if (position < 0 || position >= mState.getItemCount()) {
            ...
            if (fromScrap && !mState.isPreLayout() && holder
                ...
                if (mState.mRunSimpleAnimations) {
                    ...
                    final RecyclerView.ItemAnimator.ItemHolderInfo info = mItemAnimator.recordPreLayoutInformation(mState,
            ...
            for (int i = 0; i < scrapCount; i++) {
                ...
                if (!holder.wasReturnedFromScrap() && holder.getLayoutPosition() == position
                    ...
                    if (type != INVALID_TYPE && holder.getItemViewType() != type) {
                        LogUtils.e(TAG, "Scrap view for position " + position + " isn't dirty but has" +
    ...
    public static abstract class LayoutManager {
        ...
        public boolean requestChildRectangleOnScreen(RecyclerView parent, View child, Rect rect,
                                                     boolean immediate) {
            LogUtils.e(TAG, "requestChildRectangleOnScreen..................");
        ...
        public boolean performAccessibilityAction(Recycler recycler, State state, int action,
                                                  Bundle args) {
            LogUtils.e(TAG, "performAccessibilityAction....................");
            if (mRecyclerView == null) {
                return false;
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs,
            ...
            properties.orientation = a.getInt(android.support.v7.recyclerview.R.styleable.RecyclerView_android_orientation, VERTICAL);
    ...
    public static abstract class ViewHolder {
        ...
        public final void setIsRecyclable(boolean recyclable) {
            ...
            if (mIsRecyclableCount < 0) {
                ...
                LogUtils.e(VIEW_LOG_TAG, "isRecyclable decremented below 0: " +
                        "unmatched pair of setIsRecyable() calls for " + this);
    ...
    public boolean dispatchNestedPreScroll(int dx, int dy, int[] consumed, int[] offsetInWindow) {
        LogUtils.e(TAG, "dispatchNestedPreScroll....................");
