...
//        Util.debug("Parsing complete in " + (System.currentTimeMillis() - start) + " millis.");
    ...
    private static Integer getIntegerAttr(String name, Attributes attributes) {
        return getIntegerAttr(name, attributes, null);
    }

    private static Integer getIntegerAttr(String name, Attributes attributes, Integer defaultValue) {
    ...
    private static class SVGHandler extends DefaultHandler {
        ...
        private boolean doStroke(Properties atts) {
            ...
            if (color != null) {
                ...
                // Set defaults
                LogUtils.e(TAG,"stroke width is : " + width);
            ...
            if (localName.equals("svg")) {
                ...
                if (centerX != null && centerY != null && radiusX != null && radiusY != null) {
                    ...
                    if (doFill(props, gradientMap)) {
                        ...
                        LogUtils.e(TAG,"dofill...................");
                    }
                    if (doStroke(props)) {
                        LogUtils.e(TAG,"doStroke.................");
                        canvas.drawOval(rect, paint);
                    }
                    popTransform();
                }
            } else if (!hidden && (localName.equals("polygon") || localName.equals("polyline"))) {
                LogUtils.e(TAG, "parse polygon..........");
                ...
                LogUtils.e(TAG, "UNRECOGNIZED SVG COMMAND: " + localName);
            }
        }
