...
public class AnswerRecordListDetailActivity extends BaseActivity {
    ...
    protected void loadData() {
        ...
        NetWorkManager.queryExam(examId + "", "").subscribe(new Action1<List<HomeworkDetail>>() {
            @Override
                        ...
                        .subscribe(new Action1<List<QuestionReplyDetail>>() {
                            ...
                            public void call(List<QuestionReplyDetail> questionReplyDetails) {
                                ...
                                if (questionReplyDetails.size() > 0) {
                                    ...
                                    AnswerRecordListDetailActivity.this.showJudgeOrSelect();
                                    ...
                                    binding.contentDisplayer.getContentAdapter().deleteDataList("question", 1);
                                    binding.contentDisplayer.getContentAdapter().deleteDataList("question", 2);
