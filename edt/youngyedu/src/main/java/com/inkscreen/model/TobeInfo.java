 ...
 */
public class TobeInfo implements Serializable{
    ...
    public static class Ret implements Serializable{
        ...
        public static class StudentHomeWork  implements Serializable{
            int rightCount;
            int wrongCount;
            String status;
            boolean corrected;
...
//            }
     ...
     public List<Questions> questions;
        public static class Questions implements Serializable{
            ...
            public  StudentHomeworkQuestion studentHomeworkQuestion=new StudentHomeworkQuestion();
            public static class StudentHomeworkQuestion implements Serializable{
                ...
                List<String> notationAnswerImgs;
           ...
           String[] allAnalysis;
            ...
            public static class StudentHomeworkAnswers implements Serializable{
