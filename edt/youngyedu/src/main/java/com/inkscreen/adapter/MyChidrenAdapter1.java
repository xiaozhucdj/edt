 ...
 */
public class MyChidrenAdapter1 extends ArrayListAdapter<SortInfo.Ret.TEXTBOOK.Section.Children.Children1> {

    private boolean childSelect;

    public MyChidrenAdapter1(Context context) {
        super(context);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SortInfo.Ret.TEXTBOOK.Section.Children.Children1 workInfo = mList.get(position);
