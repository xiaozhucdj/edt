...
public final class GAdapterUtil {
    ...
    static public GObject objectFromMetadata(final OnyxMetadata data, final boolean isShowTittle) {
        ...
        object.putInt(TAG_SUB_LIBRARY_REF, data.getLibRefCount());
        object.putBoolean(TAG_SELECTABLE, false);
        return object;
    }
    ...
    static public GObject objectFromLibraryFilter(final OnyxLibraryFilter data) {
        ...
        object.putString(TAG_EXTRA_ATTRIBUTE, data.getExtraAttributes());
    ...
    static public File getFilePath(GObject object) {
        final String string = object.getString(GAdapterUtil.FILE_PATH);
    ...
    static public boolean isFile(final GObject object) {
        return GAdapterUtil.FILE_FILE.equalsIgnoreCase(object.getString(GAdapterUtil.FILE_TYPE));
    }

    static public boolean isGoUp(GObject object) {
        return GAdapterUtil.GO_UP_TYPE.equals(object.getString(GAdapterUtil.FILE_TYPE));
    }

    static public boolean isDirectory(GObject object) {
        return GAdapterUtil.FILE_DIRECTORY.equals(object.getString(GAdapterUtil.FILE_TYPE));
    }
    ...
    static public String getTitleString(GObject object) {
        return object.getString(GAdapterUtil.TAG_TITLE_STRING);
    }

    static public void setTitleString(GObject object, String titleString) {
        object.putString(GAdapterUtil.TAG_TITLE_STRING, titleString);
    }
    ...
    static public String getTagExtraAttribute(GObject object) {
        return object.getString(GAdapterUtil.TAG_EXTRA_ATTRIBUTE);
    }
    ...
    static public String getTag(GObject object) {
        return object.getString(GAdapterUtil.TAG_DATA_URL);
    }

    static public boolean hasNewBookTag(GObject object) {
        Object progress = object.getObject(GAdapterUtil.TAG_READING_PROGRESS);
        if (progress instanceof OnyxBookProgress) {
            return false;
        }
        return true;
    }

    static public boolean hasDownloadFinishTag(GObject object) {
        String path = object.getString(GAdapterUtil.FILE_PATH);
    ...
    static public boolean hasDecorationTag(GObject object) {
        String decoration = object.getString(GAdapterUtil.TAG_DECORATION);
