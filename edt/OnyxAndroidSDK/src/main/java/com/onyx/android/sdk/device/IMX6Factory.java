...
import com.onyx.android.sdk.data.util.AppConfig;
...
public class IMX6Factory implements IDeviceFactory
{
    ...
    public static class IMX6Controller extends IDeviceFactory.DefaultController
    {
         ...
         *  Ignore text enhance
         */
        private static Method sMethodGetConfigIgnoreMap= null;
        ...
        public static IMX6Controller createController()
        {
            if (sInstance == null) {
                ...
                Class<?> contrastManagerClass = ReflectUtil.classForName("android.util.ContrastManager");
                sMethodGetConfigIgnoreMap = ReflectUtil.getMethodSafely(contrastManagerClass, "getConfigIgnoreMap");
        ...
        public HashMap<String, AppConfig> getConfigIgnoreApps(Context context){
            return (HashMap<String, AppConfig>) this.invokeDeviceControllerMethod(context, sMethodGetConfigIgnoreMap);
        }
        ...
        int getUpdateMode(EpdController.UpdateMode mode)
        {
            ...
            switch (mode) {
                ...
                case GC4:
                    ...
                    break;
                case REGAL:
                    dst_mode = sModeRegal != 0 ? sModeRegal : sModeGC4;
                    break;
                case REGAL_D:
                    dst_mode = sModeRegalD != 0  ? sModeRegalD : sModeGC4;
                    break;
                default:
                    assert(false);
                    break;
