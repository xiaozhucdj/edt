...
import com.onyx.android.sdk.data.util.IgnoreTextEnhanceUtil;
...
public class OnyxSysCenter
{
    ...
    private static final String KEY_TEXT_ENHANCE_JSONOBJECT = "packageName";
    ...
    /**
     *  Add application into ignore record.
     * @param context
     * @param packageName
     * @return
     *
     */
    public static void addIgnoreTextEnhanceApp(Context context, String packageName){
        IgnoreTextEnhanceUtil.addIgnoreApp(context, packageName);
    }


    /**
     *  Delete app from ignore text enhance record.
     * @param context
     * @param packageName
     */
    public static void deleteIgnoreTextEnhanceApp(Context context, String packageName){
        IgnoreTextEnhanceUtil.deleteIgnoreApp(context, packageName);
    }


    /**
     *  Query app is in ignore text enhance record.
     * @param context
     * @param packageName
     * @return return true if the app is in record, other return false.
     */
    public static boolean queryIgnoreTextEnhanceApp(Context context, String packageName){
        return IgnoreTextEnhanceUtil.queryIgnoreApp(context, packageName);
    }

    /**
     *  get both user and config ignore text enhance apps
     * @param context
     * @return
     */
    public static Set<String> getAllIgnoreTextEnhanceAppsSet(Context context){
        return IgnoreTextEnhanceUtil.getAllIgnoreAppsPackageNameSet(context);
    }
