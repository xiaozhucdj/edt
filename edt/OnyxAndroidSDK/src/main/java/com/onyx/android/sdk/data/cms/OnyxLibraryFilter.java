...
public class OnyxLibraryFilter {
    ...
    public static class ExtraAttribute {
        ...
        public static ExtraAttribute fromJsonString(String jsonString) {
            ExtraAttribute extraAttribute = JSON.parseObject(jsonString, ExtraAttribute.class);
        ...
        public static String clearContentCount(String jsonString) {
            ExtraAttribute extraAttribute = fromJsonString(jsonString);
            extraAttribute.contentCount = 0;
            return toJsonString(extraAttribute);
        }

        public static String addContentCount(String jsonString, int count) {
            ExtraAttribute extraAttribute = fromJsonString(jsonString);
            extraAttribute.contentCount += count;
            return toJsonString(extraAttribute);
        }
    }
