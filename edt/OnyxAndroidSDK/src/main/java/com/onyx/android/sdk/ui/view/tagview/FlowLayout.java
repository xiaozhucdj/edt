...
public class FlowLayout extends ViewGroup {
    ...
    protected List<List<View>> allViews = new ArrayList<List<View>>();
    protected List<Integer> lineHeight = new ArrayList<Integer>();
    protected List<Integer> lineWidth = new ArrayList<Integer>();
    private int gravity;
